...
<html lang="pt_br">
  <head>
    ...
    <link rel="stylesheet" href="styles/editar-ajuste.css">
    <link rel="stylesheet" href="styles/global.css">
    <title>SAH | Editar ajuste</title>
  </head>
  <body>
  ...
  ?>
        ...
        <div class="row">   
            ...
            <div class="col-sm-2">
                <div class="list-group">
                    ...
                    <a href="editar-ajuste.php" class="list-group-item list-group-item-action active" aria-current="true">
                        Editar
                    </a> 
            ...
            <div class="col-sm-8">
                ...
                <div class="card">
                    ...
                    <form class="form" action="editar-ajuste.php" method="POST">
    ...
    <script src="scripts/edita.js"></script>
  </body>
</html>
